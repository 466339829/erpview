      ...
      <el-row :gutter="20">
        <el-col>
          <el-form :inline="true">
            ...
            <el-form-item label="计划单状态">
              <el-select clearable @clear="getApplyList"  v-model="queryApply.checkTag" placeholder="请选择">
    ...
    <el-dialog title="生产计划单" :visible.sync="checkDialogVisible" width="80%" @close="checkDialogClosed">
      <el-form :inline="true"  :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
        ...
        <el-row :gutter="20" style="margin-top: 20px">
          <el-col :span="6"><div ><strong>审核人: </strong>  {{apply.checker}}</div></el-col>
          <el-col :span="6"><div ><strong>审核时间: </strong>  {{apply.checkTime}}</div></el-col>
        </el-row>
        <el-row :gutter="20" style="margin-top: 20px">
          <el-col :span="6"><div ><strong>审核意见: </strong>  {{apply.checkSuggestion}}</div></el-col>
        </el-row>
      </el-form>
    </el-dialog>
